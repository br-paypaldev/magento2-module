...
namespace PayPalBR\PayPal\Block\Express;
...
class Review extends \Magento\Framework\View\Element\Template
{
    ...
    public function getShippingAddress()
    {
        ...
        $this->_quote->getShippingAddress()->setCompany(null);
    ...
    {
        return $this->_quote->getPayment()->getAdditionalInformation('method_title');
    }
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->setEditUrl(
            $this->_quote->getPayment()->getAdditionalInformation('redirect_url')
        )->setPlaceOrderUrl(
            $this->getUrl("expresscheckout/order/placeOrder", ['_secure' => true])
        );
